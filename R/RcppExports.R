...
calculateXXw <- function(X, w, ret) {
    invisible(.Call(`_testxyz1_calculateXXw`, X, w, ret))
}

maxLambda <- function(g_start) {
    .Call(`_testxyz1_maxLambda`, g_start)
}

evaluate <- function(X, y, z, lambda) {
    .Call(`_testxyz1_evaluate`, X, y, z, lambda)
}

vunion <- function(first, second) {
    .Call(`_testxyz1_vunion`, first, second)
}

vintersection <- function(first, second) {
    .Call(`_testxyz1_vintersection`, first, second)
}

vdifference <- function(first, second) {
    .Call(`_testxyz1_vdifference`, first, second)
}

findActiveSet <- function(g, z, A) {
    invisible(.Call(`_testxyz1_findActiveSet`, g, z, A))
}

sparsify <- function(w, u, l) {
    invisible(.Call(`_testxyz1_sparsify`, w, u, l))
}

projectAndSparsify <- function(w, u, l) {
    invisible(.Call(`_testxyz1_projectAndSparsify`, w, u, l))
}

aggressiveStep <- function(A, eta, z, delz_A, Kz, Ku) {
    .Call(`_testxyz1_aggressiveStep`, A, eta, z, delz_A, Kz, Ku)
}

conservativeStep <- function(A, z, delz_A) {
    .Call(`_testxyz1_conservativeStep`, A, z, delz_A)
}

update <- function(z, A, delz_A, Kz, Ku, eta) {
    .Call(`_testxyz1_update`, z, A, delz_A, Kz, Ku, eta)
}

solve <- function(X, g_start, n, z, g, lambda, whitelisted, max_iterations) {
    .Call(`_testxyz1_solve`, X, g_start, n, z, g, lambda, whitelisted, max_iterations)
}

sequential_solve <- function(X, n, z, g_start, ever_active, lambda, prev_lambda, max_iterations) {
    .Call(`_testxyz1_sequential_solve`, X, n, z, g_start, ever_active, lambda, prev_lambda, max_iterations)
}
